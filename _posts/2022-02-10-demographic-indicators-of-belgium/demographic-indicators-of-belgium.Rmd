...
description: |
  Presenting some demographic indicators of Belgium.
author:
...
In 2020, the median age of the Belgian population is `r median_age` years old which means that the number of individuals younger that age equals the number of individual older that age. The share of individuals aged more than 65 in the population equals `r share65`%. An indicator frequently encountered is the age dependency ratio which is the ratio between the population not in the labor force (aged 0 to 14 and 65+) and those usually in the labor force (ages 15 to 64). It is a proxy to reflect the pressure on the productive population and it was equal to `r ratio.dep` in 2020.
