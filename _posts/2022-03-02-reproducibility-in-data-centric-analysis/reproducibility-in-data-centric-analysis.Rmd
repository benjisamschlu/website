...
I try to maintain a project history over the life of the project in the form of a markdown file containing:
...
```{r, echo = FALSE, fig.cap="One example", preview=TRUE}
...
I presented some advises on how to conduct a research project while making it reproducible. In practice, it is frequently not as easy as presented in this post. Nonetheless, keeping these elements in mind still allows to converge towards reproducibility in data-centric analyses. 
