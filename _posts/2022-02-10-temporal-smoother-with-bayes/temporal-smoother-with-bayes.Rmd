...
where we have from left to right, the posterior distribution, the likelihood and the prior distribution. The likelihood describes the distribution of the data, depending on unknown parameters $\theta$ (see this [post](https://www.benjaminschluter.com/posts/2022-02-11-what-is-the-likelihood/)). The prior distribution expresses beliefs about $\theta$ and this beliefs can be expressed in such a way that they provide a mechanism by which smoothing can be imposed.
