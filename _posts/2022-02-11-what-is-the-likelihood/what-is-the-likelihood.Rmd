...
description: |
  Post opening the likelihood blackbox, showing its derivation and its use in a demographic context. 
author:
...
As it is clear from the above figure, the likelihood is a function of the parameter $p$ (bounded between 0 and 1 as it is a probability). Despite the fact that it looks like a probability distribution, it is not. The area under the likelihood curve does not sum to one.
