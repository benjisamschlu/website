...
Carl Bergstrom and Jevin West wrote the book ["Calling Bullshit - the art of skepticism in a data-driven world"](https://www.penguinrandomhouse.com/books/563882/calling-bullshit-by-carl-t-bergstrom-and-jevin-d-west/) based on a course they taught in 2017, entitled ["Calling Bullshit in the age of big data" ](https://www.callingbullshit.org/videos.html). 

```{r, echo = FALSE, fig.cap="Calling Bullshit book's cover", preview=TRUE}
knitr::include_graphics(path = "C:/Users/bschluter/Desktop/website/_posts/2022-02-22-calling-bullshit/book.png")
```

The aim of their course is to learn how to spot bullshit and effectively calling it, focusing on claims, not people. They are particularly seeing bullshit in the guise of big data and fancy algorithms which is the specific type of bullshit they are adressing in the course. 
